 ...
 */
public class Classificador256Bits implements Classificador {

    public static final int TAMANHO_ENTRADA = 256;

    private final Classificador128Bits[] unidadeEntrada = new Classificador128Bits[2];
    private final Classificador2Bits unidadeSaida;

    /**
     * Inicializa a unidade logica.
     */
    public Classificador256Bits() {
        for (int i = 0; i < unidadeEntrada.length; i++) {
            unidadeEntrada[i] = new Classificador128Bits();
        }
