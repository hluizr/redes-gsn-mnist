 ...
 */
public class ClassificadorMnist1024x8xSomador implements ClassificadorMnist {

    public static final int TAMANHO_SAIDA = 8;
    public static final int TAMANHO_ENTRADA_CLASSIFICADOR = 128;

    private final Classificador128Bits[][] classificadores = new Classificador128Bits[5][TAMANHO_SAIDA];
