...
import edu.esab.rbp.Classificador128Bits;
import edu.esab.rbp.Classificador64Bits;
 ...
 */
public class ClassificadorMnist1024x16xSomador implements ClassificadorMnist {
    
    public static final int TAMANHO_SAIDA = 16;
    public static final int TAMANHO_ENTRADA_CLASSIFICADOR = 64;

    private final Classificador64Bits[][] classificadores = new Classificador64Bits[5][TAMANHO_SAIDA];
