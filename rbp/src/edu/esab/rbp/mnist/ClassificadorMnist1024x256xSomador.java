...
import edu.esab.rbp.Classificador4Bits;
 ...
 */
public class ClassificadorMnist1024x256xSomador implements ClassificadorMnist {

    public static final int TAMANHO_SAIDA = 256;
    public static final int TAMANHO_ENTRADA_CLASSIFICADOR = 4;

    private final Classificador4Bits[][] classificadores = new Classificador4Bits[5][TAMANHO_SAIDA];
