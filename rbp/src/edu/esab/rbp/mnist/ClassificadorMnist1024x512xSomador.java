...
import edu.esab.rbp.Classificador2Bits;
 ...
 */
public class ClassificadorMnist1024x512xSomador implements ClassificadorMnist {

    public static final int TAMANHO_SAIDA = 512;
    public static final int TAMANHO_ENTRADA_CLASSIFICADOR = 2;

    private final Classificador2Bits[][] classificadores = new Classificador2Bits[5][TAMANHO_SAIDA];
