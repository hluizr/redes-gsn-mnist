 ...
 */
public class Classificador512Bits implements Classificador {

    public static final int TAMANHO_ENTRADA = 512;

    private final Classificador256Bits[] unidadeEntrada = new Classificador256Bits[2];
    private final Classificador2Bits unidadeSaida;

    /**
     * Inicializa a unidade logica.
     */
    public Classificador512Bits() {
        for (int i = 0; i < unidadeEntrada.length; i++) {
            unidadeEntrada[i] = new Classificador256Bits();
        }
