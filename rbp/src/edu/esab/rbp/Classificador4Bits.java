...
/**
 * Classificador para padroes de 4 entradas.
 *
 * @author Helio Rodrigues
 */
public class Classificador4Bits implements Classificador {

    public static final int TAMANHO_ENTRADA = 4;

    private final Classificador2Bits[] unidadeEntrada = new Classificador2Bits[2];
    private final Classificador2Bits unidadeSaida;

    /**
     * Inicializa a unidade logica.
     */
    public Classificador4Bits() {
        for (int i = 0; i < unidadeEntrada.length; i++) {
            unidadeEntrada[i] = new Classificador2Bits();
        }
