 ...
 */
public class Classificador16Bits implements Classificador {

    public static final int TAMANHO_ENTRADA = 16;

    private final Classificador8Bits[] unidadeEntrada = new Classificador8Bits[2];
     ...
     *
     */
    public Classificador16Bits() {
        for (int i = 0; i < unidadeEntrada.length; i++) {
            unidadeEntrada[i] = new Classificador8Bits();
        }
